...
/**
 * Be raised on setting an exist path of directory or file.
 *
 ...
 */
final class ExistPathException extends Core\Exception
{
    /**
     * {@inheritdoc}
     *
     ...
     */
    const MESSAGE = 'exist path of directory or file';
}
